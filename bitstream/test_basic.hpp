/** \file
    ...
    \details This source file contains basic tests for regression of the
...
BOOST_AUTO_TEST_CASE(test_construct_with_null)
{
    ibitstream ibs(NULL);
    BOOST_CHECK(ibs.rdbuf()->data() == NULL);
}

BOOST_AUTO_TEST_CASE(test_construct_with_empty_string)
{
    static const char c[] = "";
    ibitstream ibs(c);
...
BOOST_AUTO_TEST_CASE(test_construct_with_non_empty_string)
{
